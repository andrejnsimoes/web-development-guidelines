...
* Use [this](https://github.com/elsewhencode/project-guidelines/blob/master/.gitignore) `.gitignore` file.
...
::: tip BASED ON
[`A set of best practices for JavaScript projects (elsewhencode/project-guidelines)`](https://github.com/elsewhencode/project-guidelines) on GitHub
:::
