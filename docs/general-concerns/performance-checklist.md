...
::: tip BASED ON
[`The only Front-End Performance Checklist that runs faster than the others (thedaviddias/Front-End-Performance-Checklist)`](https://github.com/thedaviddias/Front-End-Performance-Checklist) on GitHub
:::
